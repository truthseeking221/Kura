...
const SECTION_DEFS = [
  ...
  { num: 5, name: "Recent Health",  short: "Recent Health",  sub: "Last 3 months",              Comp: Section5,
  ...
  { num: 6, name: "Lifestyle",      short: "Lifestyle",      sub: "Smoking, alcohol, diet, sleep", Comp: Section6,
