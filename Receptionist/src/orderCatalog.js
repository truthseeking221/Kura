...
export const CORE_ORDER_CATALOG = [
  ...
  { id: "cbc",          kind: "lab",     name: "Complete Blood Count (CBC)",   price: 8,  category: "Haematology", popular: true, components: ["Hemoglobin", "Hematocrit", "WBC count", "Platelet count", "MCV", "MCH"] },
  { id: "glucose",      kind: "lab",     name: "Blood Glucose (Fasting)",      price: 5,  category: "Biochemistry", popular: true, fasting: true },
  { id: "lipid",        kind: "lab",     name: "Lipid Panel",                  price: 12, category: "Biochemistry", popular: true, fasting: true, alcohol: true, components: ["HDL", "LDL", "Total cholesterol", "Triglycerides", "Cholesterol ratio"] },
  ...
  { id: "urinalysis",   kind: "lab",     name: "Urinalysis",                   price: 6,  category: "Urinalysis", popular: true, components: ["Specific gravity", "pH", "Leukocytes", "Nitrite", "Protein", "Glucose", "Ketones", "Blood"] },
  { id: "preg",         kind: "lab",     name: "Pregnancy (β-hCG)",            price: 7,  category: "Endocrinology", popular: true },
  { id: "lft",          kind: "lab",     name: "Liver Function (LFT)",         price: 13, category: "Biochemistry", alcohol: true, drugs: true, components: ["ALT", "AST", "ALP", "GGT", "Bilirubin total", "Albumin"] },
  { id: "kft",          kind: "lab",     name: "Kidney Function (KFT)",        price: 13, category: "Biochemistry", drugs: true, components: ["Creatinine", "Urea", "eGFR", "Uric acid", "Sodium", "Potassium"] },
  { id: "electro",      kind: "lab",     name: "Electrolytes Panel",           price: 9,  category: "Biochemistry", components: ["Sodium", "Potassium", "Chloride", "Bicarbonate"] },
